...
export default function LipFiller() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const categories = ['Anti-Wrinkle Injections (Men)', 'Anti-Wrinkle Injections (Women)']
        const allProducts = []
  ...
  <div className="mx-auto max-w-2xl text-center">
    <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Anti-Wrinkle Injections</h2>
  </div>
</div>
